...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">WhiteBlue Yazılım | Menü Ekleme</h1>
                <h1 class="page-subhead-line">Sitenizin Ortada Yer Alan Menüleri Buradan Değiştirebilirsiniz </h1>
            </div>
            <div class="col-md-12">
                <a href="menu-ekle.php"><button style="width: 100px;" class="btn btn-success"'>Menü Ekle</button></a>
                <hr>
            </div>
            <div class="col-md-12">
             <!--    Hover Rows  -->
