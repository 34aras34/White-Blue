...
<head>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">WhiteBlue | Slider Ekleme Sayfası</h1>
                    <hr>
                    <div>
                   <p style="color: red; font-size: 20px; text-align:  center;" >! Ekliyiceğiniz Slider Boyutu 820x400 Olmak Zorundadır !</p>
                   </div>
                    <hr>
